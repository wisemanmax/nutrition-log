...
export interface TDEEParams { mult: number; age: number; heightCm: number; sex: string }

export function calcTDEE(
  profile: { sex?: string; dob?: string; height?: string; activityLevel?: string } | null | undefined,
  _units = 'lbs',
): TDEEParams | null {
