// localStorage + Cookie utilities with AES-256-GCM encryption

const _LS_CRYPTO_ALGO = { name: 'AES-GCM', length: 256 } as const;
...
async function _getLsCryptoKey(): Promise<CryptoKey | null> {
  ...
  return window.crypto.subtle.deriveKey(
    { name: 'PBKDF2', salt: enc.encode('ironlog-ls-salt'), iterations: 100_000, hash: 'SHA-256' },
