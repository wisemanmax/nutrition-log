...
export const Icons = {
  ...
  leaf: I(<><path d="M2 22s4-2 4-8c0-3.31 2.69-6 6-6s6 2.69 6 6-4 8-4 8" /><path d="M6 14c0-4 4-6 6-6" /></>),
  droplet: I(<><path d="M12 2.69l5.66 5.66a8 8 0 11-11.31 0z" /></>),
  flame: I(<><path d="M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 11-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 002.5 3z" /></>),
  scale: I(<><circle cx="12" cy="5" r="3" /><line x1="12" y1="22" x2="12" y2="8" /><path d="M5 12H2a10 10 0 0020 0h-3" /></>),
};
